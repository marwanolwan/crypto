      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl relative overflow-hidden">
            ...
            <span className={`text-xs ${coins.length > 0 && coins[0].change24h > 0 ? 'text-green-400' : 'text-red-400'}`}>
                Bitcoin {coins.length > 0 ? coins[0].change24h.toFixed(2) : 0}%
            </span>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
            ...
            <p className="text-xl font-bold text-white">{formatNumber(globalStats.vol24h)}</p>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
            ...
            <p className="text-xl font-bold text-white">{globalStats.marketCap > 0 ? formatNumber(globalStats.marketCap) : 'بيانات محدودة'}</p>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
            ...
            <p className="text-xl font-bold text-white">{globalStats.btcDominance.toFixed(1)}%</p>
                    ...
                    {filteredCoins.map((coin) => (
                        <tr key={coin.id} className="hover:bg-slate-800/50 transition-colors group">
                            ...
                            <td className="px-6 py-4 text-slate-400">
                                {coin.marketCap > 0 ? formatNumber(coin.marketCap) : formatNumber(coin.volume)}
                            </td>
